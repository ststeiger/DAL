...
";
        ...
        protected bool DatabaseExists(string strDataBaseName)
        {
			...
			return System.IO.File.Exists(strDataBaseName);
...
";
        ...
        {
            throw new System.NotImplementedException("cSQLite_schema.cs ==> CreateDB");
        } // End Sub CreateDB


        public override void CreateDB(string strDBname, string strDataLocation, string strLogLocation)
        {
			if(!System.IO.Directory.Exists(strDataLocation))
				System.IO.Directory.CreateDirectory(strDataLocation);

			string strBasePath = System.IO.Path.Combine(strDataLocation, strDBname);
